...
if __name__ == "__main__":
    ...
    # )
    # Read the data from local repo - NO internet
    csv_url = "mlflow-sklearn/src/winequality-red.csv"
    try:
    ...
    mlflow.set_experiment(experiment_name="wine-quality-classifier")
